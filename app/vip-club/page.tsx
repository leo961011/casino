                ...
                <div className="relative w-full h-full flex-col lg:flex-row 2xl:p-8 gap-8 z-[99] items-center flex justify-between">
                    ...
                    <div className="flex flex-col gap-px rounded-[8px] w-full 2xl:w-[330px] overflow-hidden">
                        <div className=" h-12 2xl:bg-mirage bg-white-4 flex items-center p-3 justify-between">
                            <div className="flex gap-2">
                                <button className="border-[1px] border-yellow-orange w-6 h-6 rounded-[8px] flex items-center justify-center text-yellow-orange">
                        ...
                        <div className=" h-12 2xl:bg-mirage bg-white-4 flex items-center p-3 justify-between">
                            <div className="flex gap-2">
                                <button className="border-[1px] border-dodger-blue w-6 h-6 rounded-[8px] flex items-center justify-center text-yellow-orange">
                        ...
                        <div className=" h-12 2xl:bg-mirage bg-white-4 flex items-center p-3 justify-between">
                           <div className="flex gap-2">
                             <button className="border-[1px] border-malachite w-6 h-6 rounded-[8px] flex items-center justify-center text-yellow-orange">
            ...
            <ModalContainer title="VIP system level" isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                <div className="flex gap-4 flex-col">
                    <div className="flex w-full flex-col gap-[6px]">
                        <div className="grid px-4 items-center bg-mirage-8a text-center font-bold text-[12px] rounded-t-[8px] h-10 text-blue-bayoux grid-cols-[auto_100px_90px_80px] gap-2">
                            <span>VIP level</span>
                        ...
                        </div>
                        {
                            vips[1].map((vip, index) => 
                                <div className="grid px-4 items-center bg-white-4 text-center font-bold text-[14px] rounded-[8px] h-10 text-white grid-cols-[auto_100px_90px_80px] gap-2" >
