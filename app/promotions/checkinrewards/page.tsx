  ...
  return (
    <BetTemplate {...data} >
      <div className="p-4 bg-white-4 rounded-[12px] flex flex-col gap-4">
        <div className="text-[18px] font-bold text-white text-center">Activity Fund Application</div>
      ...
      <div className="p-4 bg-white-4 rounded-[12px] flex flex-col mt-4 gap-4">
        <div className="text-[14px]  text-casper text-center w-[70%] mx-auto">Sign in The seventh day continuously, and you can unlock additional rewards. After signing out, it will be recalculated from the first day</div>
        <div className=" grid grid-cols-1  2xl:grid-cols-3 justify-between items-center rounded-[12px]  gap-4">
          <div className="p-4 bg-white-4 rounded-[12px] flex flex-col items-center gap-4">
            <span className="text-white text-[14px] font-bold">0Day</span>
            <span className="text-dodger-blue text-[14px] font-bold">Continuous sign-ins this round</span>
          </div>
          <div className="p-4 bg-white-4 rounded-[12px] flex flex-col items-center gap-4">
            <span className="text-white text-[14px] font-bold">0U</span>
            <span className="text-dodger-blue text-[14px] font-bold">Reward received</span>
          </div>
