  ...
  return (
    <BetTemplate {...data} >
      <div className="p-4 bg-white-4 rounded-[12px] flex flex-col gap-4">
        <div className="text-[18px] font-bold text-white text-center">Complete tasks every day and give bonuses every day!</div>
        <div className="lg:w-[70%] w-full mx-auto text-center text-[14px] text-casper">
        ...
        <div className=" rounded-[12px] flex justify-center items-center flex-wrap gap-2 text-center text-[14px] text-casper">
          {
      ...
      <div className="bg-white-4 rounded-[12px] p-4 flex flex-col gap-4 mt-4 ">
        <div className="font-bold text-[14px] text-center text-white">How to claim the bonus</div>
