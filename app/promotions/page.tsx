      ...
      {tabs.map((tab) => {
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div className="flex justify-center">
            <div
              className="h-9 bg-ebony-clay w-[9.8125rem] gap-2 text-casper font-montserrat text-[0.875rem] flex items-center justify-center font-bold rounded-[0.5rem] hover:bg-ebony-clay/80 transition-colors"
            >
              Show 4 more
