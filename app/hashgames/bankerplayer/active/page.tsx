  ...
  return (
    <>
      ...
      <div className="bg-[#72707038] rounded-lg w-full  p-1 hidden [@media(max-width:768px)]:flex ">
        ...
        <Link
            href="/hashgames/bankerplayer/default"
          className={` w-[50%] justify-center text-center  py-1.5 rounded-lg font-bold transition-all duration-200 text-white text-[14px] border-none flex items-center gap-2 hover:bg-[rgba(255,255,255,0.08)]`}
        >
          {" "}
          <img
            src="/icons/swap-horizontal.svg"
