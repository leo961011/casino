    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="space-y-2">
            <div className="p-3 bg-purple-50 rounded-lg">
              ...
              <button className="w-full px-3 py-1 bg-purple-600 text-white text-sm rounded hover:bg-purple-700 transition-colors">
                {t('promotions.claim')}
              </button>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            <button className="w-full text-left px-4 py-2 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
              {t('help.faq')}
            </button>
            <button className="w-full text-left px-4 py-2 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
              {t('help.liveChat')}
