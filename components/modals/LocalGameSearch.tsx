...
export default function LocalGameSearchModal({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex p-2 sm:p-4 justify-center items-end sm:items-center bg-black/80">
      <div className="w-full max-w-4xl mx-auto max-h-[90vh] overflow-y-auto modal-content-scroll transform transition-all duration-300 ease-out translate-y-0">
