...
const Sidebar: React.FC = () => {
  ...
  const currentLanguageDisplay = sidebarData.languageData[currentLanguage.code as keyof typeof sidebarData.languageData] || sidebarData.languageData.cn;
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className={`p-4 pt-0 ${isCollapsed ? "px-0" : ""} space-y-1 flex-1`}>
            ...
            <div className="py-2 justify-center lg:hidden flex flex-col gap-2   rounded-[0.5rem] h-[5.1875rem] px-4 bg-[linear-gradient(45deg,#111923,#003A81)]">
              ...
              <div key={index} className="bg-white-4 rounded-[0.75rem] p-4 flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <div className="font-bold text-white text-[0.875rem] flex gap-2">
                    <button className="rounded-[0.5rem]  w-6 h-6 border flex justify-center items-center" style={{ borderColor: service.color }}>
                      {service.icon}
                    </button>
                    {service.title}
                  </div>
